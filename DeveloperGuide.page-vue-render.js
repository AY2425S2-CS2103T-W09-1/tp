...
with(this){return _c('ul',[_c('li',[_v("HR teams handling candidate pipelines")]),_v(" "),_c('li',[_v("Manages multiple candidate pipelines")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")]),_v(" "),_c('li',[_v("are data-driven decision makers")]),_v(" "),_c('li',[_v("works in a face-paced environment")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": Simplifies candidate tracking by organizing applicant information,\ncommunication history, and hiring stages for quick access in a fast, no-frills CLI environment")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a person by providing the\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NAME")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PHONE_NUMBER")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EMAIL")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ADDRESS")]),_v(" and optionally any number of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TAG")])])]),_v(" "),_c('li',[_c('p',[_v("AddressBook adds the person with the detail into the list")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The details don't follow the correct format.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. AddressBook shows an error message.")])])]),_v(" "),_c('li',[_c('p',[_v("1b. Lacks details like "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NAME")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PHONE_NUMBER")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EMAIL")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ADDRESS")]),_v(".")]),_v(" "),_c('ul',[_c('li',[_v("1b1. AddressBook shows an error message.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of persons")])]),_v(" "),_c('li',[_c('p',[_v("User requests to edit a specific person in the list using the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("INDEX")]),_v("\nand provide the new detail for that person")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook edit the person's detail")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. The new details don't follow the correct format.")]),_v(" "),_c('ul',[_c('li',[_v("3b1. AddressBook shows an error message.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to find a person by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NAME")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook find persons whose name matches at least one of the keyword (case-insensitive).")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("Should run on any mainstream OS (Windows, macOS, Linux) with Java 17 or above installed.")]),_v(" "),_c('li',[_v("Should handle up to 1000 candidates without noticeable lag in typical usage.")]),_v(" "),_c('li',[_v("Common commands (e.g., adding candidates, updating statuses, searching) should execute within 200ms under normal load.")]),_v(" "),_c('li',[_v("A user with above-average typing speed should be able to perform most tasks faster using commands than using a mouse.")]),_v(" "),_c('li',[_v("Should provide clear error messages and usage hints for invalid commands.")]),_v(" "),_c('li',[_v("Candidate data should be stored securely, ensuring unauthorized users cannot access sensitive information.")]),_v(" "),_c('li',[_v("Data should be persistently stored and not lost between sessions.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(" - Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(" - A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Applicant")]),_v(" – A person who has applied for a job and is stored as a contact in the system.")]),_v(" "),_c('li',[_c('strong',[_v("Application Metadata")]),_v(" – Information related to an applicant’s job application, such as job position, status, and contact details.")]),_v(" "),_c('li',[_c('strong',[_v("Contact")]),_v(" – A stored applicant or candidate with essential details such as name, email, phone, job position, and application status.")]),_v(" "),_c('li',[_c('strong',[_v("Custom Status")]),_v(" – A user-defined application status when the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("--custom")]),_v(" flag is used.")]),_v(" "),_c('li',[_c('strong',[_v("Error Message")]),_v(" – A notification displayed when an invalid input or operation occurs (e.g., invalid email format, missing required fields).")]),_v(" "),_c('li',[_c('strong',[_v("Email Validation")]),_v(" – A process ensuring the provided email follows a valid format (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user@domain.com")]),_v(").")]),_v(" "),_c('li',[_c('strong',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("--force")]),_v(" Flag")]),_v(" – A command option that allows updating an existing contact if a duplicate email or phone number is found.")]),_v(" "),_c('li',[_c('strong',[_v("Identifier Type")]),_v(" – A flag ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("-n")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("-e")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("-p")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("-id")]),_v(") used to specify whether a contact is searched by name, email, phone number, or system ID.")]),_v(" "),_c('li',[_c('strong',[_v("Job Position")]),_v(" – The role or position that an applicant is applying for, stored in the system.")]),_v(" "),_c('li',[_c('strong',[_v("Parameter")]),_v(" – A required or optional value provided in a command (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NAME")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EMAIL")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("STATUS")]),_v(").")]),_v(" "),_c('li',[_c('strong',[_v("Status Update")]),_v(" – A change in an applicant’s application stage using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("update")]),_v(" command.")]),_v(" "),_c('li',[_c('strong',[_v("System ID")]),_v(" – A unique numerical identifier assigned to each contact in the system.")]),_v(" "),_c('li',[_c('strong',[_v("Unique Identifier")]),_v(" – A distinct value (email, phone number, or system ID) used to identify contacts.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Tue, 25 Feb 2025, 17:45:25 GMT+8]")])])])}
}];
